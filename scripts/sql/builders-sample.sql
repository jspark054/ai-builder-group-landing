...
--
--   ⚠ 전원 등록이라 **POL-02 이니셜 폴백과 POL-12 표기 수위 혼재가 화면에서
--     발현되지 않는다.** 결정시트가 POL-12 를 「그리드 붕괴 시 불합격」으로 걸어
--     뒀으므로 인수 전에 한 번은 확인해야 한다. 다만 그 확인 때문에 프로덕션에
--     상시 빈칸을 두지는 않는다 — 필요할 때 한 명을 잠시 null 로 두고 보면 된다.
--     실빌더 전환 시에는 POL-12 가 「개인 선택」이라 혼재가 자연히 발생한다.
...
insert into public.builder (
  ...
  (
    '서재훈', '서재훈', 'nickname', 1,
    '/images/builders/seo-jaehoon.webp', '서재훈 프로필 사진',
...
--       · image_url · image_alt 전 건 채워짐 (null 0건)
