...
**카피는 확정 사항이 아니다.** 확정문서 README와 결정시트 `I-7`에
"어떤 카피도 확정이 아니다 — 기획-1안·2안 중 선택하거나 새로 써도 된다"고
명시돼 있다. 따라서 카피는 `카피후보_팀공유_*.md`를 참고 자료로만 쓰고,
실제 문구는 내 기획안·PRD를 기준으로 한다.

단 아래는 카피여도 변경하지 않는다.
- 확정 소구점 3건 (카피가 아니라 전략 프레임워크)
- POL-01 · POL-09 · POL-11① (사실·법적 근거 또는 클라이언트 지목)
