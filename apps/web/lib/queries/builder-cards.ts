...
//   P-05 의 FN-P05-02(비고정 빌더 일별 시드 셔플)는 **여기서 하지 않는다.**
//   P-01 섹션 5 와 P-05 가 같은 쿼리를 쓰는데 셔플은 P-05 규칙이고, 캐싱 단위도
//   화면 쪽에 있다. 이 함수는 결정적 순서만 보장하고, 셔플은 P-05 가 얹는다.
//
 ...
 */
export async function getBuilderCards(): Promise<BuilderCardData[]> {
