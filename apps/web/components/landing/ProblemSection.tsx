...
//
// 인터랙션 배치 — 1 없음 / **2 마퀴** / 3 순차 등장 / 4 카드 상승 /
//   5 좌→우 stagger / 7 연결선 / 8 없음. 인접한 두 섹션이 겹치지 않고
//   비워둔 구간(1·8)이 그대로 남는다 (`FN-P01-02` · `POL-11①-2`).
//   6 교육·조직은 8/22 에 삭제됐다 — app/page.tsx 머리말 참조.
// ─────────────────────────────────────────────────────────────────────────
